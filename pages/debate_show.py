...
#             st.markdown(
#                 f"## 🟢 Round {round_no} — Pro"
#             )

#         else:

#             st.markdown(
#                 f"## 🔴 Round {round_no} — Con"
#             )
...
#                     st.markdown("**Retrieved Document Chunk**")
...
#             st.warning(
#                 "This argument did not explicitly cite any retrieved document."
#             )
...
#     st.success(
#         "The 5-round debate has been completed."
#     )
